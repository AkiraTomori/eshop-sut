...
**Revised:** 2026-06-15 — FR-09 coupon content removed; counts updated; priorities and GitHub Issues filled in by HITL
...
| Bug ID | Severity | Priority | Type | Problem Summary | GitHub Issue | Status |
|--------|:--------:|:--------:|------|-----------------|:------------:|:------:|
| BUG-FR08-001 | Medium | Medium | User Interface | No `<h1>` on checkout page — uses `<h2>` (FR-21 violation) | [#21](https://github.com/AkiraTomori/eshop-sut/issues/21) | New |
| BUG-FR08-002 | Cosmetic | Low | User Interface | Checkout button is green instead of required blue (FR-21 violation) | [#22](https://github.com/AkiraTomori/eshop-sut/issues/22) | New |
| BUG-FR08-003 | Serious | Serious | Business Logic | Cart not cleared after successful order placement | [#23](https://github.com/AkiraTomori/eshop-sut/issues/23) | New |
| BUG-FR08-005 | Medium | Medium | Feature Missing | Breadcrumb navigation absent from checkout page (FR-22 violation) | [#25](https://github.com/AkiraTomori/eshop-sut/issues/25) | New |
| BUG-FR08-006 | Serious | Serious | Functionality | No UI error message when shipping address is empty or whitespace | [#26](https://github.com/AkiraTomori/eshop-sut/issues/26) | New |
| BUG-FR08-007 | Serious | Serious | Data / DB Integrity | Backend API accepts orders with empty or whitespace-only shipping_address | [#27](https://github.com/AkiraTomori/eshop-sut/issues/27) | New |
| BUG-FR08-008 | **Fatal** | **Immediate** | Security / Access Control | Backend stores client-supplied `total_amount` without recalculation — price tampering succeeds | [#28](https://github.com/AkiraTomori/eshop-sut/issues/28) | New |
| BUG-FR08-009 | Medium | Medium | Functionality | No enforcement of 255-char maximum on `shipping_address` (256+ chars accepted) | [#29](https://github.com/AkiraTomori/eshop-sut/issues/29) | New |
...
*Date: 2026-06-15 (revised — FR-09 coupon content removed; priorities and GitHub Issues #21–#29 filled in by HITL)*
*Status: Bug report Accepted by HITL — all 8 GitHub Issues filed with screenshots attached.*
