...
\| GAP-SEC-03 | Security/Schema | SQLi probes cover path \`id\`, \`name\`, and \`category\_id\`; price wrong-type cases use non-malicious values | SQL-looking string in required numeric \`price\` | FR15-EXT-SEC-003 |
